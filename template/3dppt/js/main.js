    ...
    var rotatingSlider = function (selector, options) {
        function initSingleSlider($el, options) {
            ...
            function scrollHandler(e) {
                if (rotating && !__opts.allowScrolluringAnim)
                    return;
                rotating = true;
            ...
            function keydownHandler(e) {
                if (rotating && !__opts.allowKeysDuringAnim)
                    return;
                rotating = true;
                if (e.which === 38) {
                    navigateUp();
            ...
            function dragRotationHandler(e) {
                if (rotating && !__opts.allowDragDuringAnim)
                    return;
                rotating = true;
            ...
            function initControls() {
                ...
                $(document).on('click', '.slider3d__control', function () {
                    if (rotating && !__opts.allowControlsDuringAnim)
                        return;
                    rotating = true;
